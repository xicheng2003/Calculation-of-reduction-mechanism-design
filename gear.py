...
####按齿面接触疲劳强度设计####
        ...
        if K_A*F_t1/b>=100:
            ...
            K_H_alpha=1.4#
        if gear.number==1:
            K_H_beta=(b-40)*(1.066-1.075)/(40-80)+1.066#查表10-4，插值法得到(b-40)*(1.066-1.075)/(40-80)+1.066
        else :
            K_H_beta=(b-40)*(1.075-1.066)/(80-40)+1.066#查表10-4，插值法得到(b-40)*(1.075-1.066)/(80-40)+1.066
